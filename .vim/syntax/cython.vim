...
" Based on the Pyrex syntax bundled with vim 7.3.
" Additional Cython features based on a pastebin somewhere.
...
syn keyword pyrexType		int bint long short float double char object void
syn keyword pyrexType		signed unsigned operator
